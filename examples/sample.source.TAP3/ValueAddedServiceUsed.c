...
static asn_TYPE_member_t asn_MBR_ValueAddedServiceUsed_1[] = {
...
static ber_tlv_tag_t asn_DEF_ValueAddedServiceUsed_tags_1[] = {
	(ASN_TAG_CLASS_APPLICATION | (236 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_ValueAddedServiceUsed_tag2el_1[] = {
    { (ASN_TAG_CLASS_APPLICATION | (69 << 2)), 2, 0, 0 }, /* chargeInformation at 1486 */
    { (ASN_TAG_CLASS_APPLICATION | (74 << 2)), 1, 0, 0 }, /* chargingTimeStamp at 1485 */
    { (ASN_TAG_CLASS_APPLICATION | (237 << 2)), 0, 0, 0 } /* vasCode at 1484 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ValueAddedServiceUsed_specs_1 = {
