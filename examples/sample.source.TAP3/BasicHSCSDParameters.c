...
static ber_tlv_tag_t asn_DEF_BasicHSCSDParameters_tags_1[] = {
	(ASN_TAG_CLASS_APPLICATION | (35 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_BasicHSCSDParameters_tag2el_1[] = {
    { (ASN_TAG_CLASS_APPLICATION | (60 << 2)), 2, 0, 0 }, /* channelCodingUsed at 286 */
    { (ASN_TAG_CLASS_APPLICATION | (61 << 2)), 1, 0, 0 }, /* channelCodingAcceptableList at 285 */
    { (ASN_TAG_CLASS_APPLICATION | (161 << 2)), 0, 0, 0 }, /* maxNumberOfChannels at 284 */
    { (ASN_TAG_CLASS_APPLICATION | (252 << 2)), 3, 0, 0 } /* numberOfChannelsUsed at 287 */
};
