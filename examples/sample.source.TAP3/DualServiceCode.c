...
static asn_TYPE_tag2member_t asn_MAP_DualServiceCode_tag2el_1[] = {
    { (ASN_TAG_CLASS_APPLICATION | (99 << 2)), 1, 0, 0 }, /* dualBearerServiceCode at 694 */
    { (ASN_TAG_CLASS_APPLICATION | (100 << 2)), 0, 0, 0 } /* dualTeleServiceCode at 692 */
};
