...
static asn_TYPE_member_t asn_MBR_HSCSDInformation_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct HSCSDInformation, hSCSDParameterModificationList),
		(ASN_TAG_CLASS_APPLICATION | (140 << 2)),
		0,
		&asn_DEF_HSCSDParameterModificationList,
		0,	/* Defer constraints checking to the member type */
		0,	/* PER is not compiled, use -gen-PER */
		0,
...
static ber_tlv_tag_t asn_DEF_HSCSDInformation_tags_1[] = {
	(ASN_TAG_CLASS_APPLICATION | (124 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_HSCSDInformation_tag2el_1[] = {
    { (ASN_TAG_CLASS_APPLICATION | (35 << 2)), 0, 0, 0 }, /* basicHSCSDParameters at 841 */
    { (ASN_TAG_CLASS_APPLICATION | (140 << 2)), 1, 0, 0 } /* hSCSDParameterModificationList at 842 */
};
static asn_SEQUENCE_specifics_t asn_SPC_HSCSDInformation_specs_1 = {
