...
static ber_tlv_tag_t asn_DEF_CamelCallReference_tags_1[] = {
	(ASN_TAG_CLASS_APPLICATION | (49 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_CamelCallReference_tag2el_1[] = {
    { (ASN_TAG_CLASS_APPLICATION | (33 << 2)), 0, 0, 0 }, /* mscAddress at 369 */
    { (ASN_TAG_CLASS_APPLICATION | (50 << 2)), 1, 0, 0 } /* callReferenceNumber at 370 */
};
