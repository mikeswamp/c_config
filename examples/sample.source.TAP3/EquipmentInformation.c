...
static ber_tlv_tag_t asn_DEF_EquipmentInformation_tags_1[] = {
	(ASN_TAG_CLASS_APPLICATION | (102 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_EquipmentInformation_tag2el_1[] = {
    { (ASN_TAG_CLASS_APPLICATION | (103 << 2)), 1, 0, 0 }, /* esn at 868 */
    { (ASN_TAG_CLASS_APPLICATION | (128 << 2)), 1, 0, 0 }, /* imei at 866 */
    { (ASN_TAG_CLASS_APPLICATION | (148 << 2)), 0, 0, 0 } /* mobileStationClassMark at 706 */
};
