...
int
TimeBandSubtype_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
TimeBandSubtype_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
TimeBandSubtype_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	TimeBandSubtype_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
TimeBandSubtype_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
TimeBandSubtype_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
TimeBandSubtype_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
TimeBandSubtype_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
TimeBandSubtype_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static ber_tlv_tag_t asn_DEF_TimeBandSubtype_tags_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_TimeBandSubtype = {
	"TimeBandSubtype",
	"TimeBandSubtype",
	TimeBandSubtype_free,
	TimeBandSubtype_print,
	TimeBandSubtype_constraint,
	TimeBandSubtype_decode_ber,
	TimeBandSubtype_encode_der,
	TimeBandSubtype_decode_xer,
	TimeBandSubtype_encode_xer,
